...
export default function FacilitiesQuality2() {
  return (
    <section className="fq2-section">
      ...
      <div className="fq2-bg-image">
        <Image
          src="/optimize/footer-bg.webp"
          alt=""
          fill
          sizes="100vw"
          className="fq2-bg-img"
          aria-hidden="true"
        />
      </div>
          ...
          >
            <div className="fq2-card fq2-card-facility">
              ...
              <div className="fq2-content-area">
                <span className="fq2-eyebrow">
                  Our Facility
                </span>

                <h2 className="fq2-title">
                  Built in Our Own Workshop
                </h2>

                <p className="fq2-body">
                  We run our own fabrication floor with laser cutting,
                  press brakes, welding bays, and finishing under one roof.
                  That means we control the schedule and the standard from
                  first cut to final check.
                </p>
                ...
                <div className="fq2-metrics">
                  {FACILITY_METRICS2.map((metric, index) => (
                    <div
                      key={index}
                      className="fq2-metric"
                    >
                      <span className="fq2-metric-value">
                        {metric.value}

                        {metric.suffix && (
                          <span className="fq2-metric-suffix">
                            {metric.suffix}
                          </span>
                        )}
                      </span>

                      <span className="fq2-metric-label">
                        {metric.label}
                      </span>
                    </div>
                  ))}
                ...
                <a
                  href="/facilities"
                  className="btn btn-outline-blue fq2-btn"
                >
                  Tour the Facility
                  <ArrowRight size={16} />
                </a>
          ...
          >
            <div className="fq2-card fq2-card-quality">
              ...
              <div className="fq2-content-area">
                ...
                <p className="fq2-body">
                  We inspect material when it arrives, check parts during
                  production, and sign off every job before it leaves.
                  You get work that matches the drawing, plus the paperwork
                  to prove it.
                </p>
                ...
                <div className="fq2-quality-points">
                  {QUALITY_POINTS2.map((point, index) => (
                    <div
                      key={index}
                      className="fq2-quality-point"
                    >
                      <CheckCircle2
                        size={18}
                        className="fq2-quality-icon"
                      />
